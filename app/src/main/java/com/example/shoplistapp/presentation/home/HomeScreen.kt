...
fun HomeScreen(
    ...
    Scaffold(topBar = {
        TopAppBar(
            title = {
                Text(
                    text = stringResource(R.string.global_market),
        ...
        ExtendedFloatingActionButton(onClick = { navigate.invoke() },
...
fun PreviewProductScreen() {
    HomeScreen(
        uiStateFlow = MutableStateFlow(
            HomeScreenUiState(
                false, listOf(
                    ProductItem(1, "title", 1f, "ayakkabı", "sad", "sad",1),
                    ProductItem(1, "title", 1f, "ayakkabı", "sad", "sad",2),
                    ProductItem(1, "title", 1f, "ayakkabı", "sad", "sad",3)
                )
            )
        ),
        onEvent = { },
